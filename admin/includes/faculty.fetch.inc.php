...
$query = '';
$output = array();
$query .= "SELECT * FROM user as u JOIN department_offices as d ON d.department_offices_id =u.do_id WHERE (u.user_type ='T' or u.user_type='NT') and u.user_accountStatus <> 2";
...
foreach($result as $row)
{
	...
	$sub_array[] = '<a href="includes/mini.action.php?deletefaculty='.$row["user_ref_id"].'" class="btn btn-danger btn-sm delete">Delete</a>';
	$data[] = $sub_array;
}
$output = array(
